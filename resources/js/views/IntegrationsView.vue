                    ...
                    <BaseCard>
                        <div class="space-y-5">
                            ...
                            <div class="flex items-center gap-3 pb-4 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Tracking & Analytics</h2>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Configure códigos de rastreamento para sua loja</p>
                                </div>
                            </div>
                            ...
                            <div v-else-if="!storeInfo" class="text-center py-12">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 mb-4">
                                    Conecte uma loja para configurar o tracking
                                </p>
                            </div>

                            <!-- Tracking Form -->
                            <div v-else class="space-y-5">
                                <!-- Grid 2x2 para os serviços -->
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <!-- Google Analytics 4 -->
                                    <div class="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50">
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex items-center gap-2.5">
                                                <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center flex-shrink-0">
                                                    <svg class="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M12.87 15.07l-2.54-2.51.03-.03A17.52 17.52 0 0014.07 6H17V4h-7V2H8v2H1v2h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z"/>
                                                    </svg>
                                                </div>
                                                <div>
                                                    <h3 class="font-semibold text-sm text-gray-900 dark:text-gray-100">Google Analytics 4</h3>
                                    ...
                                    <div class="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50">
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex items-center gap-2.5">
                                                <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center flex-shrink-0">
                                                    <svg class="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M12 2.04C6.5 2.04 2 6.53 2 12.06C2 17.06 5.66 21.21 10.44 21.96V14.96H7.9V12.06H10.44V9.85C10.44 7.34 11.93 5.96 14.22 5.96C15.31 5.96 16.45 6.15 16.45 6.15V8.62H15.19C13.95 8.62 13.56 9.39 13.56 10.18V12.06H16.34L15.89 14.96H13.56V21.96C18.34 21.21 22 17.06 22 12.06C22 6.53 17.5 2.04 12 2.04Z"/>
                                                    </svg>
                                                </div>
                                                <div>
                                                    <h3 class="font-semibold text-sm text-gray-900 dark:text-gray-100">Meta Pixel</h3>
                                    ...
                                    <div class="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50">
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex items-center gap-2.5">
                                                <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center flex-shrink-0">
                                                    <svg class="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
                                                ...
                                                <div>
                                                    <h3 class="font-semibold text-sm text-gray-900 dark:text-gray-100">Microsoft Clarity</h3>
                                    ...
                                    <div class="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50">
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex items-center gap-2.5">
                                                <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center flex-shrink-0">
                                                    <svg class="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
                                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                                    </svg>
                                                </div>
                                                <div>
                                                    <h3 class="font-semibold text-sm text-gray-900 dark:text-gray-100">Hotjar</h3>
                                ...
                                <!-- Info Box -->
                                <div class="p-3.5 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                                    <p class="text-sm text-blue-700 dark:text-blue-300">
                                        <strong>Dica:</strong> Os códigos de tracking serão automaticamente inseridos na sua loja quando habilitados.
                                        Certifique-se de usar os IDs corretos para evitar perda de dados.
                                    </p>
                                </div>
