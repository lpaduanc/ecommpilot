...
const tabs = [
    ...
    { id: 'tracking', name: 'Tracking & Analytics', icon: ChartBarIcon, gradient: 'from-cyan-500 to-blue-600' },
]
                        ...
                        <BaseCard v-if="activeTab === 'tracking'" padding="lg">
                            <div class="max-w-2xl">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm mb-6">
                                    Configure os códigos de rastreamento da sua loja para acompanhar métricas e comportamento dos visitantes.
                                </p>
                                ...
                                <div v-else class="space-y-6">
                                    <!-- Google Analytics 4 -->
                                    <div class="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/30">
                                        <div class="flex items-start justify-between mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100">Google Analytics 4</h3>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Métricas de tráfego e conversão</p>
                                                </div>
                                            </div>
                                        ...
                                        <div v-if="trackingForm.ga.enabled">
                                            <BaseInput
                                                ...
                                                hint="Encontre em Google Analytics > Administrador > Fluxo de dados"
                                                :disabled="!authStore.hasPermission('settings.edit')"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/30">
                                        <div class="flex items-start justify-between mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100">Meta Pixel</h3>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Facebook & Instagram Ads</p>
                                                </div>
                                            </div>
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input
                                        ...
                                        <div v-if="trackingForm.meta_pixel.enabled">
                                            <BaseInput
                                                ...
                                                hint="Encontre em Meta Business Suite > Gerenciador de Eventos"
                                                :disabled="!authStore.hasPermission('settings.edit')"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/30">
                                        <div class="flex items-start justify-between mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100">Microsoft Clarity</h3>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Heatmaps e gravação de sessões (gratuito)</p>
                                                </div>
                                            </div>
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input
                                        ...
                                        <div v-if="trackingForm.clarity.enabled">
                                            <BaseInput
                                                ...
                                                hint="Encontre em clarity.microsoft.com > Configurações > Setup"
                                                :disabled="!authStore.hasPermission('settings.edit')"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/30">
                                        <div class="flex items-start justify-between mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100">Hotjar</h3>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">Heatmaps, gravações e feedback</p>
                                                </div>
                                            </div>
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input
                                        ...
                                        <div v-if="trackingForm.hotjar.enabled">
                                            <BaseInput
                                                ...
                                                label="Site ID"
                                                placeholder="1234567"
                                                hint="Encontre em insights.hotjar.com > Sites & Organizations"
                                                :disabled="!authStore.hasPermission('settings.edit')"
                                            />
                                        </div>
                                    </div>
