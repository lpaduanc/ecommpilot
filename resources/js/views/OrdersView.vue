                        ...
                        <table class="w-full table-fixed">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                >
                                    ...
                                    <td class="px-4 py-4">
                                        <div v-if="order.customer_phone" class="flex items-center gap-1.5">
                                            <a
                                                v-if="isBrazilianMobile(order.customer_phone)"
                                            ...
                                            <span class="text-sm text-gray-600 dark:text-gray-300">{{ order.customer_phone }}</span>
                                        </div>
                        ...
                        <div class="px-4 sm:px-8 py-4 sm:py-6 max-h-[60vh] overflow-y-auto scrollbar-thin space-y-4 sm:space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    ...
                                    <div v-if="selectedOrder.customer_phone" class="flex items-center gap-3 p-3 bg-gradient-to-r from-gray-50 to-transparent dark:from-gray-700/30 rounded-xl">
                                        <div>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Telefone</p>
                                            <div class="flex items-center gap-1.5 mt-0.5">
                                                <a
                                                    v-if="isBrazilianMobile(selectedOrder.customer_phone)"
                                                ...
                                                <span class="font-medium text-gray-900 dark:text-gray-100">{{ selectedOrder.customer_phone }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
